! function(t) {
	...
	e.prototype.initSelect2 = function() {
		t('[data-bs-toggle="select2"]').select2()
		...
		jQuery().TouchSpin && (n = {}, t('[data-toggle="touchspin"]').each(function(e, a) {
			var i = t.extend({}, n, t(a).data());
			t(a).TouchSpin(i)
		}));
		var n = {};
		t('[data-bs-toggle="touchspin"]').each(function(e, a) {
			var i = t.extend({}, n, t(a).data());
			t(a).TouchSpin(i)
		})
	...
	var n = $.map(countries, function(e, a) {
		...
		e = ($.mockjax({
			...
			response: function(e) {
				var e = e.data.query,
					a = e.toLowerCase(),
					i = new RegExp("\\b" + $.Autocomplete.utils.escapeRegExChars(a), "gi"),
					a = $.grep(n, function(e) {
